...
let soundEffects = {
    ...
    convHimariLovelyHoliday: new Audio("highSchoolStories/conv_Haruki_LovelyHolidayAkari.mp3")
  };

  const getGameBoard = document.querySelector('.gameBoard');
  
  let quizPreguntasHechas = 0;
  let quizPreguntasHechasTotales = 0;

  let quizPreguntasAcertadas = 0;
  let quizPreguntasAcertadasTotales = 0
...
const checkScreenCode = `
<section id="checkScreen--mainContainer"> <!--  Este es el container que contiene la foto en la historia. 
                                            Tan grande como #gameBoard-->
          ...
          <div id="checkScreen--whiteBlock">
            ...
            <div id="checkScreen--imgContainer">
              <img src="../highSchoolStories/gameMaster.png" alt="" id="checkScreen--img" />
            </div>
          </div>
        </section>
`